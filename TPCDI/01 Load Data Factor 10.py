...
dbutils.fs.ls("dbfs:/tmp/tpc-di/10/Batch1/")
dbutils.fs.cp("dbfs:/tmp/tpc-di/10000/Batch1/Prospect.csv","dbfs:/tmp/tpc-di/10000/Prospects/Prospect.csv")
...
.option("sep", ",") \
.load("dbfs:/tmp/tpc-di/10/Prospects/") \
.writeStream \
.trigger(once=True) \
.format("delta") \
